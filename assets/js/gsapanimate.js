  ...
  var fadeAnimation = function () {
    ...
    if (fadeArray_items.length > 0) {
      ...
      fadeArray.forEach((item) => {
        let fade_direction = item.getAttribute("data-fade-from") || "bottom";
...
gsap.utils.toArray(".gallery-item").forEach((card) => {
