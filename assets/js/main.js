(function ($) {
  ...
  const oneNavOnePage = () => {
    ...
    $navLinks.on("click", function (e) {
      ...
      $(".side-menu-mobile,.offcanvas-backdrop,.offcanvas").removeClass("show");
    ...
    const updateActiveMenu = () => {
      ...
      const scrollPosition =
        $(window).scrollTop() + headerHeight + $(window).height() / 2;
      ...
      // Force last section when at page bottom
      if (
